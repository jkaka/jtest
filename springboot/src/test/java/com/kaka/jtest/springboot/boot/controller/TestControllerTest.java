...
//        session.setAttribute("user",user); //拦截器那边会判断用户是否登录，所以这里注入一个用户
    ...
    public void selectUser() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/testController/user/1")// MockMvcRequestBuilders构造一个请求，Post请求就用.post方法
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.id").value("1"))// 这里jsonPath用来获取author字段比对是否为嘟嘟MD独立博客,不是就测试不通过
